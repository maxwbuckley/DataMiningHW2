...
```
Using the wide dataset, teams and all the complete gambling data my random forest accuracy increases to 51.02%. Much better than random guessing. Though it would be difficult to profit off this data as you are attempting to use the bookies probably better predictions to predict.
...
# Try some clusering
Lets try some clustering. We can again use all the data here as I won't be predicting on the clusters. This is unsupervised learning rather than supervised.
