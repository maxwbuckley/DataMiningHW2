...
cleaned_data$Day<-weekdays(cleaned_data$Date)
...
```{r}
tree3<-ctree(FTR ~ ., data=wide_training_set[,c(2,3,6,11:43)], controls=ctree_control(maxdepth=6))
...
In the above report I have explored the provided premier 
